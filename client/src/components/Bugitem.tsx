      ...
      >
        ...
        <div className="p-5 divide-y divide-gray-400 text-gray-800">
          <div className="flex align-middle text-base font-bold font-display capitalize mb-4">
            <h1 className="capitalize">Title</h1><span className='ml-4 font-medium'>{bug.title}</span>
            <p className="ml-auto">Due date</p><span className='ml-4 font-normal'>placeholder</span> 
          </div>
          <div className=''>
