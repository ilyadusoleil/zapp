  ...
  return (
    <>
      <div>
        ...
        <br />
        <button onClick={createBug} className='shadow bg-purple-600 focus:shadow-outline focus:outline-none text-white font-body px-3 py-1 rounded-full ml-3'><FontAwesomeIcon
                    icon={faPlusCircle}
                    size={'sm'}
                    className="mr-1"
                  />
